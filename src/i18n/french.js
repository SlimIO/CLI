...
module.exports = {
    ...
    binary: {
        ...
        init_opt_add: "Addons additionnels à installer avec les addons 'built-in'.",
        ...
        add_description: "Ajoute un ou plusieurs addons dans l'agent local (Ils seront activés par défaut).",
        add_opt_disabled: "Enregistre les addons comme étant actif=false dans la configuration locale de l'agent.",
        add_opt_force: "Force une ré-installation complète des addons même s'ils sont déjà installés!",
        remove_description: "Retire un ou plusieurs addon(s) de l'agent local (cela les efface du disque).",
        ...
        build_description: "Construit et compile un agent dans un exécutable avec Node.js paqueté dedans.",
        archive_description: "Créer une archive d'addon (utile pour déployer des addons à distance avec Prism).",
        connect_description: "Connexion à un agent SlimIO local ou distant (l'addon built-in Socket doit être démarrer et utilisé sur l'hôte distant).",
        config_description: "Configure un agent local ou distant en fonctionnement.",
        schema_description: "Créer une config à partir d'un schéma JSON (voir la spécification 'JSON Schema').",
        debug_description: "Debug un agent local (naviguer au travers des fichiers dumps locals de l'agent).",
        debug_opt_clear: "Nettoie (efface du disque) tous les fichiers dumps générés par l'agent.",
        lang_description: "Configuration de la langue utiliser dans le CLI (anglais par défaut).",
        lang_selection: "Quel language souhaitez-vous ?",
        lang_registration: taggedString`'${0}' a été choisi comme la nouvelle langue a utiliser dans le CLI.`,
        ...
        get_settings: "- Options locales du CLI -"
    },
    interactive: {
    ...
    add_addon_already_installed: taggedString`Addon '${0}' déjà installé sur l'agent courant!`,
    ...
    init_warning: "!! Attention",
    init_install_deps: "Installe les dépendences",
    init_install_done: "Installation terminé!",
    ...
    init_additional_addon: taggedString`${0} Addons additionnels demandés: ${1}`,
    init_separator: "-----------------------------------------------",
